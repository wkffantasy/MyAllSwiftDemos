...
extension Migration {
    ...
    public func enumerate(_: String, _: MigrationObjectEnumerateBlock) { fatalError() }

    @available(*, unavailable, renamed: "deleteData(forType:)")
    public func deleteData(_: String) -> Bool {
        fatalError()
    }

    @available(*, unavailable, renamed: "renameProperty(onType:from:to:)")
    public func renamePropertyForClass(_: String, oldName _: String, newName _: String) { fatalError() }
}
