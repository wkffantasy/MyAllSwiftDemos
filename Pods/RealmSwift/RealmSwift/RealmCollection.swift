...
private class _AnyRealmCollectionBase<T: Object>: AssistedObjectiveCBridgeable {
    ...
    func sum<U: AddableType>(ofProperty _: String) -> U { fatalError() }
    ...
    func _addNotificationBlock(_: @escaping (RealmCollectionChange<Wrapper>) -> Void)
...
extension AnyRealmCollection {
    ...
    public func sorted(_: String, ascending _: Bool = true) -> Results<T> { fatalError() }
    ...
    public func sum<U: AddableType>(_: String) -> U { fatalError() }
